...
file_name_all <- paste(output,"/output_results/heatmap_plot_all_genes_",analysis_name,".png", sep="")

file_name_variable <- paste(output,"/output_results/heatmap_plot_variable_genes_",analysis_name,".png", sep="")
